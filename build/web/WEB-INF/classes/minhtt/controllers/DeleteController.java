    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (loginUser != null && loginUser.getRoleID().equals("AD")) {
                ...
                if (QuestionID != null && questionDao.checkQuestionInQuiz(QuestionID)==false) {
                    questionDao.delete(QuestionID);
                    url = SUCCESS;
                }else{
                    request.setAttribute("MESSAGE", "Cannot be deleted, this question is in quiz at the moment");
                }
            }
        } catch (Exception e) {
