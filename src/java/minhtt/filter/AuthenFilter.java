...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        USER.add("SearchHitoryController");      
        USER.add("ShowCreateUserPageController");
        USER.add("ShowHistoryPageControlller");
        USER.add("ShowQuizPageController");
        USER.add("TakeQuizController");
        USER.add("createUser.jsp");
        USER.add("history.jsp");
        USER.add("quiz.jsp");
        USER.add("user.jsp");
        USER.add("detail.jsp");
        USER.add("ShowDetailController");
        ...
        ADMIN.add("ShowAdminPageController");
        ADMIN.add("ShowCreatePageController");
        ADMIN.add("ShowCreateUserPageController");
        ADMIN.add("ShowUpdatePageController");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (uri.contains(".jpg") || uri.contains(".png") || uri.contains(".gif") || uri.contains(".css")) {
                ...
                if ( uri.contains("login.jsp")  || uri.contains("LoginController") ||uri.contains("ShowCreateUserPageController") || uri.contains("createUser.jsp") 
                        || uri.contains("CreateUserController") || uri.contains("LogoutController")) {
                    chain.doFilter(request, response);
                    return;
                }
